                        ...
                        {activeTab === "RatingsOptions" && (
                            ...
                            {/*rating mark option section*/}
                                <div className="Rating-mark-options">
                                    <h1 className="Rating-mark-options-Title">Rating Mark Options</h1>
                                    <div className="Rating-mark-options-text-boxes">
                                        <div className="rating-mark-options-text">
                                            <p><br />Number of Pixels (spacing) Between Rating Boxes:</p><br />
                                            <p>Color of the Rating Boxes:</p><br />
                                            <p>Type of the Rating Mark:</p><br />
                                        </div>
                                        <div className="rating-mark-options-boxes">
                                            <div className="rating-mark-options-text-dropdown">
                                                <select id="dropdown" value={selectedValue} onChange={handleSelectChange} className="rating-mark-options-text-dropdown1">
                                            ...
                                            <div className="rating-mark-options-boxes-color"><input type="color" className="checkbox-input1" /></div>
                                            <div className="rating-mark-options-text-dropdown">
                                                <select id="dropdown" value={selectedValueMark} onChange={handleSelectChangeMark} className="rating-mark-options-text-dropdown2">
                                ...
                                <div className="Rating-mark-options">
                                    <h1 className="Rating-mark-options-Title">Rating Icon Options</h1>
                                    <div className="Rating-mark-options-text-boxes">
                                        <div className="rating-mark-options-text">
                                            <p><br />Print Bigger Icon (only works when a single rting is selected in all sections): </p><br />
                                            <p>Print Icons in Report Summary (only work when a single rating is selectedd in all selection): </p><br />
                                            <p>indent item description to line up with comments and only show ratings icons at the top of each section: </p><br />
                                        </div>
                                        <div className="rating-mark-options-boxes">
                                            <div className="rating-mark-options-text-dropdown">
                                                <select id="dropdown" value={selectedValueOption} onChange={handleSelectChangeOptions} className="rating-mark-options-text-dropdown1">
