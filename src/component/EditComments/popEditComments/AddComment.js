            ...
            <div className='Contant-editcomm'>
                <div className='template-card-editcomm'>
                    <div className="template-selector-editcomm">
                        ...
                        <button onClick={onClose} className="close-button-editcomm">X</button>
                    </div>
                        ...
                        <ul className="flex gap-5 pl-4">
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2'>
                                    <div className="flex justify-center">
                                        <img src={img1} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                            ...
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2' onClick={clickCreatePop}>
                                    <div className="flex justify-center">
                                        <img src={img2} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                                    <span>Create/Edit Lists</span>
                                </li>
                                {isCreateListVisiable && (
                                    <CreateListEditComm onClose={() => setIsCreateListVisiable(false)} />
                                )
                                }
                            </div>
                            ...
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2'>
                                    <div className="flex justify-center">
                                        <img src={img3} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                                    <span>Add Note</span>
                                </li>
                            </div>
                            ...
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2'>
                                    <div className="flex justify-center">
                                        <img src={img4} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                            ...
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2'>
                                    <div className="flex justify-center">
                                        <img src={img5} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                                    <span>Link</span>
                                </li>
                            </div>
                            ...
                            <div className='text-sm hover:bg-gray-300 cursor-pointer'>
                                <li className='p-2'>
                                    <div className="flex justify-center">
                                        <img src={img7} alt="" style={{ width: '30px', height: '30px' }} />
                                    </div>
                            ...
                            <li className='flex items-center'>
                                <span onClick={handleBoldClick} style={{ cursor: 'pointer', textDecoration: isBold ? 'underline' : 'none' }}>B</span>
                            </li>
                            <li className='flex items-center'>
                                <span onClick={handleItalicClick} style={{ cursor: 'pointer', fontStyle: isItalic ? 'italic' : 'normal' }}>I</span>
                            </li>
                            <li className='flex items-center'>
                                <span onClick={handleUnderlineClick} style={{ cursor: 'pointer', textDecoration: isUnderline ? 'underline' : 'none' }}>U</span>
                            </li>
                    ...
                    <div className="button-container-editcomm">
                        ...
                        <button className="cancel-button-editcomm" onClick={onClose}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
