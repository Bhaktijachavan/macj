  ...
  const handleDeleteFromCloud = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        "http://localhost:7000/api/inspection",
        {
    ...
    <div className="container-for-the-mobileuploadpopup">
      ...
      <div className="width-set-for-the-mobileuploadpopup">
        ...
        <div className="container-button-mobileuploadpopup">
          <button
            className="delete-button-mobileuploadpopup"
          ...
          <button
            className="refresh-button-mobileuploadpopup"
              ...
              {inspectionData ? (
                inspectionData.map((data) => (
                  <tr key={data._id}>
                    ...
                    <td>
                      <button onClick={() => window.open(data.pdf, "_self")}>
                        <img
                          src={img}
                          alt=""
